...
\begin{table}[]
\centering
\caption{Support Vector Machine classifier performances while using 3 grams. \hspace{\textwidth} TP: True positive, TN: True Negative, FN: False Negative, FP: False Positive }
\label{tab:3gram-svm}
\resizebox{\textwidth}{!}{%
...
\begin{table}[]
\centering
\caption{Linear Regression classifier performances while using 3 grams. \hspace{\textwidth} TP: True positive, TN: True Negative, FN: False Negative, FP: False Positive }
\label{tab:3gram-lr}
\resizebox{\textwidth}{!}{%
\begin{tabular}{llllllllll}
\hline
...
\begin{table}[]
\centering
\caption{Random Forest classifier performances while using 3 grams. \hspace{\textwidth} TP: True positive, TN: True Negative, FN: False Negative, FP: False Positive }
\label{tab:3gram-rf}
\resizebox{\textwidth}{!}{%
\begin{tabular}{llllllllll}
\hline
